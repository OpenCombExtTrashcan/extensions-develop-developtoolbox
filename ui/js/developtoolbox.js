jQuery(function () {
	...
	//取得一个随机的名字
	function getAName(){
		var nIndex = Math.floor(Math.random()*sGirlNames.length);
		var sAName = sGirlNames[nIndex];
		removeElementByIndex(nIndex,sGirlNames);
		return sAName;
	}
